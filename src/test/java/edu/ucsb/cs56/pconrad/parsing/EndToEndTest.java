...
public class EndToEndTest {
    ...
    @Test public void testNum() {
        assertEquals(42, evaluateNoException("42"));
    }

    @Test public void testAdd() {
        assertEquals(3, evaluateNoException("1 + 2"));
    }

    @Test public void testPrecedence() {
        assertEquals(23, evaluateNoException("3 + 4 * 5"));
    }

    @Test public void testParens() {
        assertEquals(17, evaluateNoException("3 * 4 + 5"));
    }

    @Test public void testIntegerDiv() {
        assertEquals(5, evaluateNoException("16/3"));
    }
