...
public class DefaultASTFactory implements ASTFactory {
	...
	public static final AST stubAST = new AST(){
			public String toString() { return "AST(Stub)"; }
		};

	// New AST nodes
	
	public AST makeEqualsNode(AST left, AST right) { return stubAST; }	
	public AST makeNotEqualsNode(AST left, AST right) { return stubAST; }
	public AST makeLessThanNode(AST left, AST right) { return stubAST; }
	public AST makeLessThanOrEqualsNode(AST left, AST right) { return stubAST; }
	public AST makeGreaterThanNode(AST left, AST right) { return stubAST; }
	public AST makeGreaterThanOrEqualsNode(AST left, AST right) { return stubAST; }
	
	public AST makeExponentNode(AST left, AST right) { return stubAST; }
